...
def learning(parameter):
    ...
    net = model_book.CNNs(p_dropout1=0, p_dropout2=0, use_Barch_Norm=False).to(device)

    # optimizer = optim.SGD(net.parameters(),lr=parameter.LEARNING_RATE, momentum=0.9, weight_decay=parameter.WEIGHT_DECAY)   #Adams検討
    optimizer = optim.Adam(net.parameters(),lr=parameter.LEARNING_RATE, weight_decay=parameter.WEIGHT_DECAY)   #Adams検討
